...
<div class="col-xxl-6 offset-xxl-3">
    <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                <td style="width: 30%;border-width: 3px;border-color: var(--bs-table-color);">{{ucfirst($title)}}</td>
                <td style="width: 30%;border-width: 3px;border-color: var(--bs-table-color);"><button class="btn btn-primary" type="button">dodaj ksiazke</button></td>
            </tr>
            @endforeach
            <tr></tr>
            </tbody>
